...
<html lang="pt-br">
  ...
  <body>
    <main>
      <div class="container container-custom" style="max-width: 70%; padding-top: 0.5rem; margin-top:0.5rem">
      <div class="container" style='background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("./src/img/placeholder-01.jpg");'>
