...
function desc(value){
    ...
    switch(value){
        case "pais1": 
            ...
            img1.style.backgroundImage="url(public/assets/img/imgs_descricoes/hong_kong.jpg);"
            img2.style.backgroundImage="url(./img/imgs_descricoes/macau.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/shenzhen.jpg)"
            break;
        case "pais2":
            ...
            img1.style.backgroundImage="url(./img/imgs_descricoes/rio_de_janeiro.jpg)"
            img2.style.backgroundImage="url(./img/imgs_descricoes/sao_paulo.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/salvador.jpg)"
            break;
        case "pais3":
            ...
            img1.style.backgroundImage="url(./img/imgs_descricoes/los_angeles.jpg)"
            img2.style.backgroundImage="url(./img/imgs_descricoes/orlando.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/new_york.jpg)"
            break;
        case "pais4": 
            ...
            img1.style.backgroundImage="url(./img/imgs_descricoes/bangkok.jpg)"
            img2.style.backgroundImage="url(./img/imgs_descricoes/ayutthaya.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/lopburi.jpg)"
            break;
        case "pais5":
            ...
            img1.style.backgroundImage="url(./img/imgs_descricoes/londres.jpg)"
            img2.style.backgroundImage="url(./img/imgs_descricoes/manchester.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/liverpool.jpg)"
            break;
        case "pais6":
            ...
            img1.style.backgroundImage="url(./img/imgs_descricoes/chinatown.jpg)"
            img2.style.backgroundImage="url(./img/imgs_descricoes/sentosa.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/distrito_colonial.jpg)"
            break;
        case "pais7": 
            ...
            img1.style.backgroundImage="url(./img/imgs_descricoes/paris.jpg)"
            img2.style.backgroundImage="url(./img/imgs_descricoes/lyon.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/nice.jpg)"
            break;
        case "pais8":
            ...
            img1.style.backgroundImage="url(./img/imgs_descricoes/roma.jpg)"
            img2.style.backgroundImage="url(./img/imgs_descricoes/milao.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/veneza.jpg)"
            break;
        case "pais9":
            ...
            img1.style.backgroundImage="url(./img/imgs_descricoes/tokyo.jpg)"
            img2.style.backgroundImage="url(./img/imgs_descricoes/kyoto.jpg)"
            img3.style.backgroundImage="url(./img/imgs_descricoes/osaka.jpg)"
            break;
    }
